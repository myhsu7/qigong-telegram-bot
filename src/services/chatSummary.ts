...
export const buildWebAppCheckinSummary = (payload: any, locale: Locale = 'zh_TW') => {
    ...
    const labels = locale === 'en'
        ? { success: '✅ Check-in complete', makeup: '✅ Make-up check-in complete', methods: 'Methods', date: 'Practice date', streak: 'Current streak', total: 'Total check-ins', unlocked: '🎉 Newly unlocked:', badge: 'New badge', day: 'days', year: '' }
        : locale === 'zh_CN'
            ? { success: '✅ 打卡成功', makeup: '✅ 补登成功', methods: '练习功法', date: '练功日期', streak: '连续打卡', total: '总打卡天数', unlocked: '🎉 新解锁成就：', badge: '新勋章', day: '天', year: '年' }
            : { success: '✅ 打卡成功', makeup: '✅ 補登成功', methods: '練習功法', date: '練功日期', streak: '連續打卡', total: '總打卡天數', unlocked: '🎉 新解鎖成就：', badge: '新勳章', day: '天', year: '年' };
    const separator = locale === 'en' ? ', ' : '、';
    const summaryLines = [
        payload?.entryKind === 'makeup' ? labels.makeup : labels.success,
        '',
